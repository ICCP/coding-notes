...
\author{Connor Glosser, Jos Seldenthuis, Chris Verzijl, \\ 
  ...
  \titlepic{
    \begin{figure}[b]
      \centering
      \includegraphics[width=0.33\pdfpagewidth]{figures/MSU_logo.pdf}\hfill \includegraphics[width=0.33\pdfpagewidth]{figures/TU_logo.pdf}
    \end{figure}
  }
\maketitle
\tableofcontents
...
\include{chapters/Graphs_and_figures}

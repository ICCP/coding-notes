...
\newcommand{\commentstyle}{\itshape\color{Blue}}
\newcommand{\keywordstyle}{\bfseries\color{DarkRed}}
\newcommand{\stringstyle}{\color{Magenta}}
...
\newcommand{\keyword}[1]{\texttt{\keywordstyle#1}}
\newcommand{\str}[1]{\texttt{\stringstyle#1}}

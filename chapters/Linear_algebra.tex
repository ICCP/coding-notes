...
Under Ubuntu, install the \texttt{liblapack-dev} package to obtain BLAS and \idx{LAPACK}, and don't forget to add \texttt{-lblas} and \texttt{-llapack} to \texttt{\$(LIBS)} in your \texttt{Makefile}.} libraries.
Everyone does.

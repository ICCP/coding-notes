...
Under Ubuntu, install\index{LAPACK!installation} the \texttt{liblapack-dev} package to obtain BLAS and \indexentry{LAPACK}, and don't forget to add \texttt{-lblas} and \texttt{-llapack} to \texttt{\$(LIBS)} in your \texttt{Makefile}.} libraries.
Everyone does.
